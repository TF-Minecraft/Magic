...
public final class WeaponResonanceDisplay {
    ...
    public static void appendLoreResonanceBlock(List<String> block, WeaponRequirement requirement) {
        ...
        appendElementLines(block, requirement, "");
    }
